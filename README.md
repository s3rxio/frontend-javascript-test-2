# Посмотри на меня!
Задание выполнено и результат вы можете посмотреть здесь https://frontend-javascript-test-2.s3rxio.ru

Либо вы можете самостоятельно сбилдить проект следуя этим командам:
...
yarn preview
```
Так же вы можете использовать Docker Compose b запустить проект одной командой :)
```
docker compose up
```
